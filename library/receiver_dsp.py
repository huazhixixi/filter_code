...
from .numba_core import lms_equalize_core
...
class LMS(Equalizer):
    ...
    def __init__(self, ntaps, loops, train_iter, lr_train, lr_dd=None):
    ...
    def equalize(self, signal):
        ...
        for idx in range(self.loops):
            ...
            symbols, self.wxx, self.wxy, self.wyx, \
            self.wyy, error_xpol_array, error_ypol_array \
                = lms_equalize_core(samples_xpol, samples_ypol, signal.symbol,
